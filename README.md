...
4. Install PyG and its `torch_scatter` dependency according to the [official instructions](https://pytorch-geometric.readthedocs.io/en/stable/install/installation.html)
   ...
   # install `torch_scatter` optional dependency (e.g. for CUDA 13.0)
   pip install torch_scatter -f https://data.pyg.org/whl/torch-2.12.0+cu130.html
   ```
...
- \[`cpu`|`cu132`|`cu130`|`cu126`\]: Required mutually exclusive extras to install the project with a PyTorch version
